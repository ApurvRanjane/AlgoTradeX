    ...
    return ( 
       <div className="container mt-5">
        <div className="row text-center ">
            ...
            <p>Extend your trading and investment expirience even further with our partner platforms</p>
          

            <div className="col-4 p-3  mt-5">
                <img src="media/images/smallcaseLogo.png" style={{ width: "120px", height: "auto" }}/>
                <p className='text-small text-muted'>Theamatic investment platform</p>
            </div>
            <div className="col-4 p-3  mt-5">
            ...
            <div className="col-4 p-3  mt-5">
             ...
             <div className="col-4 p-3 mt-5">
                <img src="media/images/zerodhaFundhouse.png" style={{ width: "120px", height: "auto" }}/>
                <p className='text-small text-muted'>Arrest management</p>
            </div>
            <div className="col-4 p-3  mt-5">
